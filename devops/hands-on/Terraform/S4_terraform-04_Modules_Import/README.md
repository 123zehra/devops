...
- Create two EC2 instances one's ami is `Amazon Linux 2023` and the other is `Ubuntu 24.04`. Their tags will be `Name=aws-linux-2023` and `Name=ubuntu-24.04`. Attach security group to these instances.
...
variable "tf-ami" {
  type = list(string)
  default = ["ami-06c68f701d8090592", "ami-04a81a99f5ec58529", "ami-0583d8c7a9c35822c"]
}

variable "tf-tags" {
  type = list(string)
  default = ["aws-linux-2023", "ubuntu-24.04", "red-hat-linux-9"]
}
